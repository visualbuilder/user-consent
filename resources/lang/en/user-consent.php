...
return [
    ...
    'print-header' => 'Your Company  - User Consent',
    'print-footer' => 'Printed ' . date('d M Y'),
    'email-opening' => 'Thank for accepting the consent options.  A summary of your preferences is shown below',
    ...
    'users-accepted-warning' => 'You may either:- Only apply to new users OR require all users to accept the new terms',
    'editable-consent' => 'No users have accepted this version yet so a new version will not be created if you make any changes.',
    'save-btn' => '{0} Update Contract|[1,*] Save as new version :version',
];
